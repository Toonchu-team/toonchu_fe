    ...
    <main className="mx-auto flex flex-col items-center justify-start gap-5 py-8 text-main-text">
      ...
      <section className="flex w-[280px] flex-col gap-1 bg-white font-bold">
        ...
        <p>
          ...
          버린다냥...
          <br />
          지금까지 함께 모은 <span className="text-main-red"> 소중한 기억</span>
        ...
        <form className="relative flex w-full flex-col gap-2">
          <input
            ...
            className="mt-2 w-full rounded-md border-2 border-main-text py-2 pl-2 pr-8 hover:border-main-yellow focus:border-main-yellow focus:outline-main-yellow"
